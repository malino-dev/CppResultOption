...
template<typename T, typename E>
class Result<Option<T>, E> final : public ResultBase<Option<T>, E>
{
public:
#pragma region Constructors
    Result(ResultOkTag tag, T value)
        : ResultBase<Option<T>, E>(tag, value)
    {
    }

    Result(ResultErrTag tag, E err)
        : ResultBase<Option<T>, E>(tag, err)
    {
    }
#pragma endregion
...
template<typename T, typename E>
class Result<Result<T, E>, E> final : public ResultBase<Result<T, E>, E>
{
public:
#pragma region Constructors
    Result(ResultOkTag tag, Result<T, E> value)
        : ResultBase<Result<T, E>, E>(tag, value)
    {
    }

    Result(ResultErrTag tag, E err)
        : ResultBase<Result<T, E>, E>(tag, err)
    {
    }
#pragma endregion
